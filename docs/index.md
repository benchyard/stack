...
![The Benchyard product group](assets/stack.svg)
...
committing, then check that page with Argos. The [working example](use-case.md)
...
is integrated. See [architecture and capability boundaries](architecture.md).
